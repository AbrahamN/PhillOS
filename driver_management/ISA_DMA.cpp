...
void initFloppyDMA(IntPositiveType address){
    ...
    ShortPositiveType count = 0x23ff;
     ...
     *
     */
    ShortPositiveType firstHalf = low_16(address);
    ShortPositiveType secondHalf = high_16(address);

    // total of 24 bytes from our address
    ByteType firstThird = low_8(firstHalf);
    ByteType secondThird = high_8(firstHalf);
    ByteType thirdThird = low_8(secondHalf);
