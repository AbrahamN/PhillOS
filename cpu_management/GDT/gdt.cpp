...
typedef struct
{
    ShortPositiveType LimitLow;
    ShortPositiveType BaseLow;
    ByteType MiddleLow;
    ByteType Access;
    ByteType FlagLmitHi;
    ByteType BaseHight;
...
typedef struct
{
    ShortPositiveType Limit;     // sizeof(gdt) - 1
...
extern "C" void gdt_load(GDTDescriptor* descriptor, ShortPositiveType codeSegment, ShortPositiveType dataSegment);
